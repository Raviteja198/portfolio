    ...
    <section id="home" className="min-h-screen flex items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center w-full">
        <div className="text-center md:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">RAVITEJA MUSKU</h1>
          <h2 className="text-xl sm:text-2xl text-cyan-200 font-semibold mt-2">Cybersecurity Analyst · Application Security Enthusiast</h2>
          ...
          <div className="mt-6 flex gap-3 justify-center md:justify-start">
            ...
            <a href="/resume.pdf" download aria-label="Download Resume" className="px-4 py-2 rounded-md border border-slate-600 text-slate-200">Download Resume</a>
          </div>

          <div className="mt-6 flex gap-4 justify-center md:justify-start text-slate-300">
            <a href="#">GitHub</a>
            <a href="#">LinkedIn</a>
        ...
        <div className="flex justify-end">
          <div className="w-full max-w-xs md:max-w-md card p-6 overflow-hidden">
            <VisualNode />
